...
class Melody  {
  ...
  //  var _preferredLanguage: String = NSLocale.preferredLanguages()[0].stringValue
   ...
   var _emissionStaticDescription:Dictionary<String,String> =
    ...
    "Melody Karaoké": "Le meilleur de la chanson française et internationale des années 60 à 90",
     ...
     "Concert de nuit": "Un tube des années 60 à 90 rencontre sa reprise des années 2000 ou 2010, présenté par Thierry CADET."  ,
     "Télé-Achat": "Un tube des années 60 à 90 rencontre sa reprise des années 2000 ou 2010, présenté par Thierry CADET."  ,
    ...
    ["Melody Matin": UIImage(named: "melody_matin")!   ,
        ...
        "Générations Melody ou Melody de ma vie":  UIImage(named: "melody_karaoke")!,
         "Melody est à vous":  UIImage(named: "melody_karaoke")!
    ]
    

    var _grilleTvUrl:String = "http://www.melody.tv/json-new/grids/view/"
    
    var _artistjsonDevUrl:String = "http://www.Melody-hd.com/jsonDev/get/artistes/?lang=\(NSLocale.preferredLanguages()[0])&platform=tablet_ios_small"
    var _museejsonDevUrl:String = "http://www.Melody-hd.com/jsonDev/get/musees/?lang=\(NSLocale.preferredLanguages()[0])&platform=tablet_ios_small"
    var _getStreamUrl:String = "http://www.melody.tv/json/livetv/getallstream/iphone?lang=fre"
    var _slideShowImagesUrl:String = "http://www.melody.tv/images/stories/showcase/applis/"
    var _seeAlsoUrl:NSURL = NSURL(string:"http://www.melody.tv/json-new/videos/voiraussimob" )!
...
//        _museumItemsType = [MuseumItemType.Artist, MuseumItemType.Melody, MuseumItemType.Theme]
   ...
   func createNewUserWithName(name:String, address:String, birthdate:String, city:String, country:String, email:String, gender:String, phone:String, subscribed:String, surname:String,token:String){
    ...
    func autoLoginAboMode(){
        ...
        request(.GET, "http://www.melody.tv/json-new/users/authenticate/\(email)/\(pass)")
            ...
            .responseSwiftyJSON{(request, response, json, error) in
                ...
                if (error?.code > -2000)
                {
                    ...
                    println(" \(error)_No Internet connection")
