...
class MelodyTB: UITabBarController,UITabBarControllerDelegate, UIActionSheetDelegate {
    ...
    var _selectedImages  = [UIImage(named: "home-off")!,UIImage(named: "actualites-off")!,UIImage(named: "direct-off")!,UIImage(named: "grille-off")!,UIImage(named: "club-off")!,UIImage(named: "replay-off")!,UIImage(named: "compte-off")!]
