...
class GrilleTvVC: UIViewController , UICollectionViewDelegate,UICollectionViewDataSource, MBProgressHUDDelegate,UITableViewDelegate, UITableViewDataSource, MZFormSheetBackgroundWindowDelegate, SlideNavigationControllerDelegate{
    ...
    func loadiPadView(){
        self.navigationController?.navigationBar.setBackgroundImage(UIImage(named: "header-grille-1024"), forBarMetrics: UIBarMetrics.Default)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        tracker.set(kGAIScreenName, value: "Page de Grille TV")
    ...
    func startGetGrilleTvRequest(date:NSDate){
        ...
        request(.GET,  kMLDGrilleTVUrl + date.toGrilleTvUrlFormatString() + "?token=" +  _melody._userToken)
            ...
            if let video = subJson["Video"].dictionaryObject{
              ...
              //  println("Subjson \(subJson)")
                ...
                if (_melody._emissionStaticDescription[name] != nil){
                    ...
                    println(" \(name) not found in  \(_melody._emissionStaticDescription)")
               ...
               // println("Name \(name) valueDescription [\(valueDescription)]")
                ...
                if(_melody._emissionStaticImages[name] != nil){
                    ...
                    println(" [\(name)[ not found image in  \(_melody._emissionStaticImages)")
